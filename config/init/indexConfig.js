...
nconfConfig.argv().env().file("config", conf_file);

function saveConfigArguments(){
    ...
    var rampArrival = nconfConfig.get('rampArrival');
    ...
    var rampVus = nconfConfig.get('rampVus');
...
export function parseArgumentAsArray(arg) {
