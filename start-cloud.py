...
def help():
    ...
    print("--rampArrival.maxVus                      Set up rampArrival max vus (e.g: --rampArrival.maxVus=null)")
    print("--rampArrival.startRate                   Set up rampArrival start rate (e.g: --rampArrival.startRate=300)")
    print("--rampArrival.timeUnit                    Set up rampArrival time unit (e.g: --rampArrival.timeUnit=1m)")
    print("--rampArrival.startTime                   Set up rampArrival start time (e.g: --rampArrival.startTime=null)")
    print("--rampArrival.gracefulStop                Set up rampArrival graceful stop (e.g: --rampArrival.gracefulStop=null)")
